...
# Description: This script analyzes loan applicant data to identify key risk factors, build predictive models, 
#              and provide actionable insights to optimize the loan approval process, reduce default rates, 
